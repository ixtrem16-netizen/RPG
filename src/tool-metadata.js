...
export const TOOL_DEFINITIONS = Object.freeze([
    ...
    },
    {
        ...
        primary: true,
        homeColumnSpan: 2,
        tabLabelKey: 'tools.world-builder.name',
        badgeKey: 'shell.badges.editor',
        nameKey: 'tools.world-builder.name',
        descriptionKey: 'tools.world-builder.description',
    },
    {
        id: 'grip-editor',
        icon: '✦',
        section: 'editor',
        primary: true,
        tabLabelKey: 'tools.grip-editor.name',
        badgeKey: 'shell.badges.editor',
        nameKey: 'tools.grip-editor.name',
        descriptionKey: 'tools.grip-editor.description',
    },
    {
        id: 'village-browser',
        icon: '⌂',
